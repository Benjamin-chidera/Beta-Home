...
const UserPropertyDetails = () => {
  ...
  const getProperty = async () => {
    try {
      ...
      setSimilar(data.similiarProperties)
      setIsLoading(false)
    } catch (error) {
      console.log(error);
    }
          ...
          <div className="d-flex justify-content-between">
            ...
            <div className="d-flex flex-column gap-4 align-items-end ">
              ...
              <p className="fw-bold UserPropertyDetPrice">
                <span className="naira">N</span> {property.price}
              </p>
            </div>
          </div>

          <div className="UserPropertyDetailsImages w-100 d-flex flex-lg-row flex-column gap-3 " style={{width: "619px"}}>
            <div className="main flex-grow-1 " style={{width: `75%`}}>
              <img
            ...
            <div className="UserPropertyDetailsExtraImg d-md-flex d-none flex-lg-column flex-md-row gap-2 h-100 position-relative" style={{width: `25%`}}>
